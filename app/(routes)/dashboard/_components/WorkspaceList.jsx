...
function WorkspaceList() {
    ...
    return (
        <div
            className='md:my-10 my-5 py-3 px-4 md:px-24 lg:px-36 xl:px-52'
        >
            <div className='flex justify-between'>
                <h2 className='font-bold md:text-2xl text-xl'>Hello, {user?.fullName} </h2>
            ...
            {workspaceList?.length == 0 ?
                ...
                :
                <div>
                    <WorkspaceItemList workspaceList={workspaceList} Layout={Layout} />
                </div>
            }
        </div>
    )
